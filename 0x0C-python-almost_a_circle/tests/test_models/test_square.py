#!/usr/bin/python3
"""Definition of Module for test Square class"""
import unittest
...
class TestSquareMethods(unittest.TestCase):
    ...
    def test_new_square_2(self):
        """This Test new square with all attributs"""
        new = Square(2, 5, 5, 4)
    ...
    def test_value_attrs_2(self):
        """This is used to pass invalid values"""
        with self.assertRaises(ValueError):
            new = Square(1, -1)
    ...
    def test_load_from_file_2(self):
        ...
        for j in range(len(linput)):
            self.assertEqual(linput[j].__str__(), loutput[j].__str__())
